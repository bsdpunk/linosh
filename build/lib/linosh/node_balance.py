...
def nodebal_list(api_key):
    ...
    endpoint = "https://api.linode.com/?api_key=" + api_key + "&api_action=nodebalancer.list"
...
def nodebal_node_list(api_key, config_id):
    headers = {'content-type': 'application/json'}
    print(config_id)    
    endpoint = "https://api.linode.com/?api_key=" + api_key + "&api_action=nodebalancer.node.list&ConfigID="+ config_id
    print(endpoint)
    r = requests.get(endpoint, headers=headers)
    json_data = json.loads(r.text) 
...
def nodebal_config_list(api_key, node_bal_id):
    headers = {'content-type': 'application/json'}
    #print(config_id)    
    endpoint = "https://api.linode.com/?api_key=" + api_key + "&api_action=nodebalancer.config.list&NodeBalancerId="+node_bal_id
    #print(endpoint)
    r = requests.get(endpoint, headers=headers)
    json_data = json.loads(r.text) 
